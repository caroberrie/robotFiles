...
void setup() {
  ...
  Serial.begin(9600);
  left.attach(leftMotor, 1000, 2000);
  right.attach(rightMotor, 1000, 2000);
  //Digital Outputs
...
void extinguish() {
  fan(true);
  delay(2000);
  setMotors(-180 / leftTrim, 180 / rightTrim);
  delay(300);
  setMotors(-130 / leftTrim, 130 / rightTrim);
  delay(300);
  setMotors(-80 / leftTrim, 80 / rightTrim);
  delay(5000);
  stopMotors();
  delay(1000);
  setMotors(180 / leftTrim, -180 / rightTrim);
...
void setMotors(int dLeftSpeed, int dRightSpeed) {
  ...
  left.write(map(constrain(leftSpeed * leftTrim, -255, 255), -255, 255, 0, 180));
  right.write(map(constrain(rightSpeed * rightTrim, -255, 255), -255, 255, 0, 180));
